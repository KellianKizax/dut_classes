...
// 3_Lib_DecryptageBrute.cs : fichier de la procédure 'Decryptage_brute()'
// Kellian GOFFIC
...
namespace LibrairieCesar
{
    public class DecryptageBrute
    {
        ...
        public static void Decryptage_brute(string Xchaine)
        {
            ...
            {
                chaine_decryptee = Decryptage.Decryptage_chaine(Xchaine, decalage);
