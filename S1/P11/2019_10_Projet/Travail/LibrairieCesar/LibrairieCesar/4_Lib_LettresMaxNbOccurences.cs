...
// 4_Lib_LettresMaxNbOccurences.cs : fichier de la fonction 'Lettres_maimum_nb_occurences()'
// Kellian GOFFIC
...
{
    public class LettresMaxNbOccurences
    {
        ...
        public static string Lettres_maximum_nb_occurences(string Xchaine)
        {
            ...
            while (chaine_sanslettresmax != "")
            {
                ...
                {
                    occurences = NombreOccurences.Nb_occurences(chaine_sanslettresmax, chaine_sanslettresmax[i]);
                ...
                {
                    if (lettres_max.Contains(Xchaine[i].ToString()) == false)
                    {
