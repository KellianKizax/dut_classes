...
// Decryptage.cs : fichier de la fonction Decryptage_chaine()'
// Kellian GOFFIC

using System;

class Decryptage_Copie
{
    ...
    public static void Decryptage_analysefrequentielle(string Xchaine)
    {
        ...
        lettres_ordreoccurences = LettresMaxNbOccurences_Copie.Lettres_maximum_nb_occurences(Xchaine); 
